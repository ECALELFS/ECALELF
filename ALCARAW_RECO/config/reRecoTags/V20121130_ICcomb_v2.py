...
# Prima tag con corr di EoP per runC
# Sul db int
# EcalIntercalibConstants_V20121130_PizC_EleABC_2012HR9EtaScaleABC_CorrEoP
# (5 IOV per C)
RerecoGlobalTag = cms.ESSource("PoolDBESSource",
				...
				cms.PSet(record = cms.string("EcalIntercalibConstantsRcd"),
					tag = cms.string("EcalIntercalibConstants_V20121130_PizC_EleABC_2012HR9EtaScaleABC_CorrEoP"),
