...
int main(int argc, char **argv)
{
  ...
  else{ std::cout<<" Exit from code, no input file"<<std::endl; std::exit(EXIT_FAILURE); }
  ...
  if( evalStat )
  {
    ...
    else{ std::cout<<" Exit from code, no even input file"<<std::endl; std::exit(EXIT_FAILURE); }
