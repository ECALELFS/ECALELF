...
int main (int argc, char ** argv) {
  ...
  else{ std::cout<<" Exit from code, no input list found"<<std::endl; std::exit(EXIT_FAILURE); }
  ...
  else{ std::cout<<" No input File Dead Xtal found! "<<std::endl;  }

  std::string inputTree = "NULL";
  if(Options.existsAs<std::string>("inputTree"))
    inputTree = Options.getParameter<std::string>("inputTree");
  else{ std::cout<<" Exit from code, no input tree found"<<std::endl; std::exit(EXIT_FAILURE); }
  ...
  else{ std::cout<<" Exit from code, no jsonFile found"<<std::endl; std::exit(EXIT_FAILURE); }
  ...
  else{ std::cout<<" no miscalib map found"<<std::endl; }
