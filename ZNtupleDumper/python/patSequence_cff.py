...
patElectrons.userData.userFloats.src = [
    ...
    cms.InputTag("eleNewEnergiesProducer",    "energyEleFra" ),
    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshEleSemiParamV4_ecorr"),
    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshEleSemiParamV4_sigma"),
    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshEleSemiParamV4_alpha1"),
    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshEleSemiParamV4_gamma1"),
    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshEleSemiParamV4_alpha2"),
    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshEleSemiParamV4_gamma2"),
    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshEleSemiParamV4_pdfval"),

    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshEleSemiParamV5_ecorr"),
    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshEleSemiParamV5_sigma"),
    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshEleSemiParamV5_alpha1"),
    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshEleSemiParamV5_gamma1"),
    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshEleSemiParamV5_alpha2"),
    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshEleSemiParamV5_gamma2"),
    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshEleSemiParamV5_pdfval"),

    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshPhoSemiParamV4_ecorr"),
    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshPhoSemiParamV4_sigma"),
    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshPhoSemiParamV4_alpha1"),
    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshPhoSemiParamV4_gamma1"),
    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshPhoSemiParamV4_alpha2"),
    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshPhoSemiParamV4_gamma2"),
    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshPhoSemiParamV4_pdfval"),
                                                              
    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshPhoSemiParamV5_ecorr"),
    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshPhoSemiParamV5_sigma"),
    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshPhoSemiParamV5_alpha1"),
    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshPhoSemiParamV5_gamma1"),
    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshPhoSemiParamV5_alpha2"),
    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshPhoSemiParamV5_gamma2"),
    cms.InputTag("eleNewEnergiesProducer",    "energySCEleJoshPhoSemiParamV5_pdfval"),
