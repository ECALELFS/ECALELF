...
RerecoGlobalTag = cms.ESSource("PoolDBESSource",
                               ...
                               toGet = cms.VPSet(
                                 cms.PSet(record = cms.string("EcalIntercalibConstantsRcd"),
                                          tag = cms.string("EcalIntercalibConstants_Cal_Nov2015_EoP_v5"),
                                          connect = cms.untracked.string("sqlite_file:/afs/cern.ch/cms/CAF/CMSALCA/ALCA_ECALCALIB/RunII-IC/Cal_Nov2015/eop/EcalIntercalibConstants_Cal_Nov2015_EoP_v5.db"),
                                          ),
