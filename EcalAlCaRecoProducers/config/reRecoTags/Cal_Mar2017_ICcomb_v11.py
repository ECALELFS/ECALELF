...
##
# IC with transport factors from phiSym. Same as comb_v4, but using the right tags for phiSym
# Run2016B, CD, EF, G, H
...
RerecoGlobalTag = GlobalTag.clone(
    ...
    toGet = cms.VPSet(
        ...
        cms.PSet(record = cms.string("EcalIntercalibConstantsRcd"),
                 tag = cms.string("EcalIntercalibConstants_Cal_Mar2017_eopPNcorrection_comb_v11"),
                 connect = cms.string('frontier://FrontierPrep/CMS_CONDITIONS')
                 ),
