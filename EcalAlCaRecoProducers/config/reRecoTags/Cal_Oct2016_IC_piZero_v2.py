...
# IC from GT + transport factor from piZero derived on 4fb-1 
...
RerecoGlobalTag = GlobalTag.clone(
    ...
    toGet = cms.VPSet(
        cms.PSet(record = cms.string("EcalIntercalibConstantsRcd"),
                 ...
                 connect = cms.string("sqlite_file:/afs/cern.ch/cms/CAF/CMSALCA/ALCA_ECALCALIB/RunII-IC/Cal_Oct2016/pizero/tags/sqlite/EcalIntercalibConstants_trans_2016vs2015_v1.db"),
                 )
        ),
    )
