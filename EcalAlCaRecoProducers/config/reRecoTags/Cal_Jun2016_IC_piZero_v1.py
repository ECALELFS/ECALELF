...
RerecoGlobalTag = GlobalTag.clone(
        ...
        cms.PSet(record = cms.string("EcalIntercalibConstantsRcd"),
                 ...
                 connect = cms.string("sqlite_file:/afs/cern.ch/cms/CAF/CMSALCA/ALCA_ECALCALIB/RunII-IC/Cal_Jun2016/pizero/tags/sqlite/EcalIntercalibConstants_trans_2016vs2015_v1.db")
                 )
