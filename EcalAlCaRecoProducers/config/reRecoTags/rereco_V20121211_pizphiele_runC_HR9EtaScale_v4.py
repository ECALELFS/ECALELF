...
# la tag con le correzioni mediate ad 1 applicate alla combinazione con i pi0 corretti
RerecoGlobalTag = cms.ESSource("PoolDBESSource",
                               ...
                               toGet = cms.VPSet(
                                cms.PSet(record = cms.string("EcalIntercalibConstantsRcd"),
                                        tag = cms.string("EcalIntercalibConstants_V20121211_NLTPizCorPhiEle_2012HR9EtaScaleABC_TCorEoP"),
