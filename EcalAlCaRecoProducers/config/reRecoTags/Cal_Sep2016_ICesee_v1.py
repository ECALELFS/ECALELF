...
# this rereco is equivalent to the prompt reco but ADCToGeV is a single iov for 2016, 
# this is done to remove from the history artificial jumps introduced by changing conditions during the year
# and is used as reference for the September calibration
...
RerecoGlobalTag = GlobalTag.clone(
        ...
        cms.PSet(record = cms.string("ESEEIntercalibConstantsRcd"),
                 tag = cms.string("ESEEIntercalibConstants_LG_2016"),
                 connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS"),
                 ),
