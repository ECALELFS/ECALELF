...
# transport with phisym using same thresholds for 2015D and 2016B
...
#rereco with IC from phiSym, using transport from 2015D to 2016B but with SAME energy thresholds for the two years.
# so as _v1 but with SAME thresholds. This should be less biased or unbiased
...
RerecoGlobalTag = GlobalTag.clone(
        ...
        cms.PSet(record = cms.string("EcalIntercalibConstantsRcd"),
                 tag = cms.string("EcalIntercalibConstants_trans_2016vs2015_v2"),
                 connect = cms.string("sqlite_file:/afs/cern.ch/cms/CAF/CMSALCA/ALCA_ECALCALIB/RunII-IC/Cal_Jun2016/phiSym/tags/sqlite/EcalIntercalibConstants_trans_2016vs2015_v2.db")
                 )
