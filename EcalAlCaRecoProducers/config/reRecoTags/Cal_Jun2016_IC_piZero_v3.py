...
RerecoGlobalTag = GlobalTag.clone(
        ...
        cms.PSet(record = cms.string("EcalIntercalibConstantsRcd"),
                 tag = cms.string("EcalIntercalibConstants_2016B_v2"),
                 connect = cms.untracked.string("sqlite_file:/afs/cern.ch/cms/CAF/CMSALCA/ALCA_ECALCALIB/RunII-IC/Cal_Jun2016/pizero/tags/sqlite/EcalIntercalibConstants_2016B_v2.db")
                 )
