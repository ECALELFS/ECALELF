...
RerecoGlobalTag = cms.ESSource("PoolDBESSource",
                               ...
                               toGet = cms.VPSet(
                                 ...
                                 cms.PSet(record = cms.string("EcalPulseShapesRcd"),
                                          ...
                                          connect = cms.untracked.string("sqlite_file:/afs/cern.ch/work/e/emanuele/public/ecal/pulseshapes_db/ecaltemplates_popcon_data_Run2015D_AlCaP0_lonebunch.db"),
                                          ),
