...
ls -tr /afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions15/13TeV/*13TeV_PromptReco_Collisions15*_JSON*.txt | grep -v Muon |grep -v CaloOnly | grep -v ZeroTesla| grep 25ns | grep -v LOWPU | tail -1
ls -tr /afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions15/13TeV/*13TeV_PromptReco_Collisions15*_JSON*.txt | grep -v Muon |grep -v CaloOnly |grep -v ZeroTesla| grep 25ns | grep LOWPU | tail -1
