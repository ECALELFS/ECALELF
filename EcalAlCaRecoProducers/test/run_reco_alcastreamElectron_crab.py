...
config.General.requestName = 'reco_stream_runD-v2'
config.General.workArea = 'reco_stream_runD-v2'
config.section_('JobType')
config.JobType.psetName = 'EcalAlCaRecoProducers/test/reco_RAW2DIGI_RECO_alcastreamElectron.py'
config.JobType.pluginName = 'Analysis'
config.JobType.pyCfgParams = ['tagFile=/afs/cern.ch/user/l/lbrianza/work/public/EoPtest_december2015/ICset_multifit_20loop_2015/Cal_Dec2015_ICEoP_ref.py']
...
config.Data.outLFNDirBase = '/store/group/dpg_ecal/alca_ecalcalib/ecalMIBI/lbrianza/AlCaElectron-Run2015D-v1-RECO-v2/'
