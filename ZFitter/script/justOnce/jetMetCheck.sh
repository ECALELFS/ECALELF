...
python macro/standardDataMC.py -d tmp/Moriond17_newRegrFix_LT/d_chain.root,data -s tmp/Moriond17_newRegrFix_LT/s_chain.root,MC "EB-eleID_loose25nsRun22016Moriond-Et_25-isEle-noPF" "(80,80,100)" invMass_ECAL_ele --noScales --no-smearings  -n EB-noScales_noSmearings
...
python macro/standardDataMC.py -d tmp/Moriond17_newRegrFix_LT/d_chain.root,data -s tmp/Moriond17_newRegrFix_LT/s_chain.root,MC "EB-eleID_loose25nsRun22016Moriond-Et_25-isEle-noPF-Et_200_400" "(80,80,100)" invMass_ECAL_ele  -n EB-Et_200_400

python macro/standardDataMC.py -d tmp/Moriond17_newRegrFix_LT/d_chain.root,data -s tmp/Moriond17_newRegrFix_LT/s_chain.root,MC "EB-eleID_loose25nsRun22016Moriond-Et_25-isEle-noPF-Et_400_800" "(80,80,100)" invMass_ECAL_ele  -n EB-Et_400_800
