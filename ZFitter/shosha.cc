...
bool isEB(float eta)
{
	return fabs(eta) < 1.48;
}
bool isEE(float eta)
{
	return fabs(eta) > 1.56 && fabs(eta) < 2.5;
}
bool isMod1(float eta)
{
	return fabs(eta) <= 0.45;
}
bool isMod2(float eta)
{
	return fabs(eta) > 0.45 && fabs(eta) <= 0.79;
}
bool isMod3(float eta)
{
	return fabs(eta) > 0.79 && fabs(eta) <= 1.14;
}
bool isMod4(float eta)
{
	return fabs(eta) > 1.14 && fabs(eta) <= 1.48;
}
