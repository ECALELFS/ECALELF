...
def comp(branchname, filename, binning, xlabel, ratio, nele, logx=False, saveHists = False):
...
binning = "(1000,0,300)"
comp(branchname, filename, binning, xlabel, (.8,1.2), 2, logx=True, saveHists=True)
