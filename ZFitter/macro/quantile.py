...
#7 highEta lowR9
#9 highEta highR9
#file_Et_data=ROOT.TFile('Cat_histos/Et_hist_smearerCat4_random_data.root','READ')
#file_Et_MC  =ROOT.TFile('Cat_histos/Et_hist_smearerCat4_random_MC.root','READ')
...
while(Et_max< X_size):
    ...
    #while(Et_hist_data.Integral(Et_min,Et_max,Et_min,Et_max)<n_min and Et_max<X_size):
    print Et_min, Et_max, X_size, Et_hist_MC.Integral(Et_min,Et_max,Et_min,Et_max)
    ...
    if(Et_hist_MC.Integral(Et_min,Et_max,Et_min,Et_max)>=n_min and Et_max<X_size):
        #this is if 1 bin has already enough stat
        Et_min_bins.append(Et_min)
        Et_max_bins.append(Et_max)
        Et_min_cuts.append(Et_min*X.GetBinWidth(1))
        Et_max_cuts.append(Et_max*X.GetBinWidth(1))
