...
//   delete c;
  ...
  c = PlotDataMCs(data, MakeChainVector(signalA,signalB,signalC), "etaEle", "(100,-2.5,2.5)", "eleID_loose-trigger-noPF-Et_25", "", "", mcLabel_vec, "#eta", "", false, true);
   c->SaveAs(outputPath+"etaEle-Et_25.eps");
   c->SaveAs(outputPath+"etaEle-Et_25.C");
  delete c;
  
  c = PlotDataMCs(data, MakeChainVector(signalA,signalB,signalC), "phiEle", "(100,-5,5)", "eleID_loose-trigger-noPF-Et_25", "", "", mcLabel_vec, "#phi", "", false, true); 
  c->SaveAs(outputPath+"phiEle-Et_25.C");
  c->SaveAs(outputPath+"phiEle-Et_25.eps");
  delete c;

  c = PlotDataMCs(data, MakeChainVector(signalA,signalB,signalC), "R9Ele", "(100,0.7,1.2)", "EB-eleID_loose-trigger-noPF-Et_25", "", "", mcLabel_vec, "R_{9}", "", false, true); 
  c->SaveAs(outputPath+"R9Ele_EB.eps");
  c->SaveAs(outputPath+"R9Ele_EB.C");
  delete c;

  c = PlotDataMCs(data, MakeChainVector(signalA,signalB,signalC), "R9Ele", "(110,0.3,1.4)", "EB-eleID_loose-trigger-noPF-Et_25", "", "", mcLabel_vec, "R_{9}", "",true,  false); 
  c->SaveAs(outputPath+"R9Ele_EB-log.eps");
  c->SaveAs(outputPath+"R9Ele_EB-log.C");
  delete c;

  c = PlotDataMCs(data, MakeChainVector(signalA,signalB,signalC), "R9Ele", "(100,0.7,1.2)", "EE-eleID_loose-trigger-noPF-Et_25", "", "", mcLabel_vec, "R_{9}", "", false, true); 
  c->SaveAs(outputPath+"R9Ele_EE.eps");
  c->SaveAs(outputPath+"R9Ele_EE.C");
  delete c; 
   c = PlotDataMCs(data, MakeChainVector(signalA,signalB,signalC), "R9Ele", "(110,0.3,1.4)", "EE-eleID_loose-trigger-noPF-Et_25", "", "", mcLabel_vec, "R_{9}", "",true, false); 
  ...
  c = PlotDataMCs(data, MakeChainVector(signalA,signalB,signalC), "invMass_SC", "(400,80,100)", "eleID_loose-trigger-noPF-EB", "", "", mcLabel_vec, "M_{ee} std SC [GeV]", "", false, true); 
  c->SaveAs(outputPath+"invMass_SC-EB.eps");
  delete c;

  c = PlotDataMCs(data, MakeChainVector(signalA,signalB,signalC), "invMass_SC_regrCorr_ele", "(400,80,100)", "eleID_loose-trigger-noPF-EB", "", "", mcLabel_vec, "M_{ee} ele-tuned V3 [GeV]", "", false, true); 
  c->SaveAs(outputPath+"invMass_SC_regrCorr_ele-EB.eps");
  delete c;

  c = PlotDataMCs(data, MakeChainVector(signalA,signalB,signalC), "invMass_SC", "(400,80,100)", "eleID_loose-trigger-noPF-EE", "", "", mcLabel_vec, "M_{ee} std SC [GeV]", "", false, true); 
  c->SaveAs(outputPath+"invMass_SC-EE.eps");
  delete c;

  c = PlotDataMCs(data, MakeChainVector(signalA,signalB,signalC), "invMass_SC_regrCorr_ele", "(400,80,100)", "eleID_loose-trigger-noPF-EE", "", "", mcLabel_vec, "M_{ee} ele-tuned V3 [GeV]", "", false, true); 
  c->SaveAs(outputPath+"invMass_SC_regrCorr_ele-EE.eps");
  delete c;

  c = PlotDataMCs(data, MakeChainVector(signalA,signalB,signalC), "invMass_SC_regrCorrSemiParV5_ele", "(400,80,100)", "eleID_loose-trigger-noPF-EB", "", "", mcLabel_vec, "M_{ee} ele-tuned V5 [GeV]", "", false, true); 
  c->SaveAs(outputPath+"invMass_SC_regrCorr_ele-EB.eps");
  delete c;

  c = PlotDataMCs(data, MakeChainVector(signalA,signalB,signalC), "invMass_SC_regrCorrSemiParV5_ele", "(400,80,100)", "eleID_loose-trigger-noPF-EE", "", "", mcLabel_vec, "M_{ee} ele-tuned V5 [GeV]", "", false, true); 
  c->SaveAs(outputPath+"invMass_SC_regrCorr_ele-EE.eps");
  delete c;


//     c = PlotDataMCs(data, MakeChainVector(signalA,signalB), "invMass_SC_regrCorrSemiParV4_ele / invMass_SC_regrCorrSemiParV5_ele -1", "(250,-0.025,0.025)", "EB-eleID_loose-trigger-noPF-Et_25","", "", mcLabel_vec, "(ele-tuned) regrV4/regrV5 -1 ", "", false, true); 
// }
//   c->SaveAs(outputPath+"/regrSCEleSemiParV4_regrSCEleSemiParV5-EB.eps");
//   delete c;

//     c = PlotDataMCs(data, MakeChainVector(signalA,signalB), "invMass_SC_regrCorrSemiParV4_pho/invMass_SC_regrCorrSemiParV5_pho -1", "(250,-0.025,0.025)", "EB-eleID_loose-trigger-noPF-Et_25","", "", mcLabel_vec, "(pho-tuned) regrV4/regrV5 -1 ", "", false, true); 
//   c->SaveAs(outputPath+"/regrSCEleSemiParV4_regrSCEleSemiParV5_pho-EB.eps");
//   delete c;

//     c = PlotDataMCs(data, MakeChainVector(signalA,signalB), "invMass_SC_regrCorrSemiParV4_ele/invMass_SC_regrCorrSemiParV5_ele -1", "(250,-0.025,0.025)", "EE-eleID_loose-trigger-noPF-Et_25","", "", mcLabel_vec, "(ele-tuned) regrV4/regrV5 -1 ", "", false, true); 
//   c->SaveAs(outputPath+"/regrSCEleSemiParV4_regrSCEleSemiParV5-EE.eps");
//   delete c;

//     c = PlotDataMCs(data, MakeChainVector(signalA,signalB), "invMass_SC_regrCorrSemiParV4_pho/invMass_SC_regrCorrSemiParV5_pho -1", "(250,-0.025,0.025)", "EE-eleID_loose-trigger-noPF-Et_25","", "", mcLabel_vec, "(pho-tuned) regrV4/regrV5 -1 ", "", false, true); 
//   c->SaveAs(outputPath+"/regrSCEleSemiParV4_regrSCEleSemiParV5_pho-EE.eps");
//   delete c;

//     c = PlotDataMCs(data, MakeChainVector(signalA,signalB), "invMass_SC_regrCorrSemiParV4_ele/invMass_SC_regrCorr_ele -1", "(250,-0.025,0.025)", "EB-eleID_loose-trigger-noPF-Et_25","", "", mcLabel_vec, "Electron regrV4/regrV3 -1 ", "", false, true); 
//   c->SaveAs(outputPath+"/regrSCEleSemiParV4_regrSCEle-EB.eps");
//   delete c;

//     c = PlotDataMCs(data, MakeChainVector(signalA,signalB), "invMass_SC_regrCorrSemiParV5_ele/invMass_SC_regrCorr_ele -1", "(250,-0.025,0.025)", "EB-eleID_loose-trigger-noPF-Et_25","", "", mcLabel_vec, "Electron regrV5/regrV3 -1 ", "", false, true); 
//   c->SaveAs(outputPath+"/regrSCEleSemiParV5_regrSCEle-EB.eps");
//   delete c;

//     c = PlotDataMCs(data, MakeChainVector(signalA,signalB), "invMass_SC_regrCorrSemiParV4_pho/invMass_SC_regrCorr_pho -1", "(250,-0.025,0.025)", "EB-eleID_loose-trigger-noPF-Et_25","", "", mcLabel_vec, "Electron regrV4/regrV3 -1 ", "", false, true); 
//   c->SaveAs(outputPath+"/regrSCEleSemiParV4_regrSCPho-EB.eps");
//   delete c;

//     c = PlotDataMCs(data, MakeChainVector(signalA,signalB), "invMass_SC_regrCorrSemiParV5_pho/invMass_SC_regrCorr_pho -1", "(250,-0.025,0.025)", "EB-eleID_loose-trigger-noPF-Et_25","", "", mcLabel_vec, "Electron regrV5/regrV3 -1 ", "", false, true); 
//   c->SaveAs(outputPath+"/regrSCEleSemiParV5_regrSCPho-EB.eps");
//   delete c;

//     c = PlotDataMCs(data, MakeChainVector(signalA,signalB), "invMass_SC_regrCorrSemiParV4_ele/invMass_SC_regrCorr_ele -1", "(250,-0.025,0.025)", "EE-eleID_loose-trigger-noPF-Et_25","", "", mcLabel_vec, "Electron regrV4/regrV3 -1 ", "", false, true); 
//   c->SaveAs(outputPath+"/regrSCEleSemiParV4_regrSCEle-EE.eps");
//   delete c;

//     c = PlotDataMCs(data, MakeChainVector(signalA,signalB), "invMass_SC_regrCorrSemiParV5_ele/invMass_SC_regrCorr_ele -1", "(250,-0.025,0.025)", "EE-eleID_loose-trigger-noPF-Et_25","", "", mcLabel_vec, "Electron regrV5/regrV3 -1 ", "", false, true); 
//   c->SaveAs(outputPath+"/regrSCEleSemiParV5_regrSCEle-EE.eps");
//   delete c;

//     c = PlotDataMCs(data, MakeChainVector(signalA,signalB), "invMass_SC_regrCorrSemiParV4_pho/invMass_SC_regrCorr_pho -1", "(250,-0.025,0.025)", "EE-eleID_loose-trigger-noPF-Et_25","", "", mcLabel_vec, "Electron regrV4/regrV3 -1 ", "", false, true); 
//   c->SaveAs(outputPath+"/regrSCEleSemiParV4_regrSCPho-EE.eps");
//   delete c;

//     c = PlotDataMCs(data, MakeChainVector(signalA,signalB), "invMass_SC_regrCorrSemiParV5_pho/invMass_SC_regrCorr_pho -1", "(250,-0.025,0.025)", "EE-eleID_loose-trigger-noPF-Et_25","", "", mcLabel_vec, "Electron regrV5/regrV3 -1 ", "", false, true); 
...
//   delete c;
  ...
  c = PlotDataMCs(data, MakeChainVector(signalA,signalB,signalC), "nPV", "(40,0,40)", "eleID_loose-trigger-noPF-Et_25", "", 
		 "", mcLabel_vec, "nVtx", "", false, false); 
  c->SaveAs(outputPath+"nPV-noweight.eps");
  delete c;

  c = PlotDataMCs(data, MakeChainVector(signalA,signalB,signalC), "nPV", "(40,0,40)", "eleID_loose-trigger-noPF-Et_25", "", 
		 "", mcLabel_vec, "nVtx", "", false, true); 
...
//   c = PlotDataMCs(data, MakeChainVector(signalA,signalB,signalC), "invMass_SC_regrCorr_ele/invMass_SC -1", "(500,-0.2,0.2)", "EB-eleID_loose-trigger-noPF-Et_25","", "", mcLabel_vec, "Electron (Hgg) regression/std. SC -1 ", "", false, true); 
//   c->SaveAs(outputPath+"/regrSCEle_stdSC-EB.eps");
//   delete c;

//     c = PlotDataMCs(data, MakeChainVector(signalA,signalB,signalC), "invMass_SC_regrCorr_pho/invMass_SC -1", "(500,-0.2,0.2)", "EB-eleID_loose-trigger-noPF-Et_25","", "", mcLabel_vec, "Photon (Hgg) regression/std. SC -1 ", "", false, true); 
//   c->SaveAs(outputPath+"/regrSCPho_stdSC-EB.eps");
//   delete c;


//   //
//     c = PlotDataMCs(data, MakeChainVector(signalA,signalB,signalC), "invMass_regrCorr_egamma/invMass_SC -1", "(500,-0.2,0.2)", "EB-eleID_loose-trigger-noPF-Et_25","", "", mcLabel_vec, "Electron (Egamma) regression/std. SC -1 ", "", false, true); 
//   c->SaveAs(outputPath+"/regrEleEgamma_stdSC-EB.eps");
//   delete c;

//     c = PlotDataMCs(data, MakeChainVector(signalA,signalB,signalC), "invMass_SC_regrCorr_ele/invMass_SC -1", "(500,-0.1,0.1)", "EE-eleID_loose-trigger-noPF-Et_25","", "", mcLabel_vec, "Electron (Hgg) regression/std. SC -1 ", "", false, true); 
//   c->SaveAs(outputPath+"/regrSCEle_stdSC-EE.eps");
//   delete c;

//     c = PlotDataMCs(data, MakeChainVector(signalA,signalB,signalC), "invMass_SC_regrCorr_pho/invMass_SC -1", "(500,-0.1,0.1)", "EE-eleID_loose-trigger-noPF-Et_25","", "", mcLabel_vec, "Photon (Hgg) regression/std. SC -1 ", "", false, true); 
//   c->SaveAs(outputPath+"/regrSCPho_stdSC-EE.eps");
//   delete c;

//     c = PlotDataMCs(data, MakeChainVector(signalA,signalB,signalC), "invMass_regrCorr_egamma/invMass_SC -1", "(500,-0.1,0.1)", "EE-eleID_loose-trigger-noPF-Et_25","", "", mcLabel_vec, "Electron (Egamma) regression/std. SC -1 ", "", false, true); 
//   c->SaveAs(outputPath+"/regrEleEgamma_stdSC-EE.eps");
//   delete c;


//   // cluster corrections and ES energy fraction
//   c = PlotDataMCs(data, MakeChainVector(signalA,signalB,signalC), "esEnergySCEle/(rawEnergySCEle+esEnergySCEle)", "(100,0,0.2)", "absEta_1.7_2.5-eleID_loose-trigger-noPF-Et_25","", "", mcLabel_vec, "ES energy fraction: ES/(rawSC+ES) ", "", false, true); 
//   c->SaveAs(outputPath+"/esEnergyFraction.eps");
//   delete c;
  
//   c = PlotDataMCs(data, MakeChainVector(signalA,signalB,signalC), "energySCEle/(rawEnergySCEle+esEnergySCEle)", "(100,0.99,1.15)", "EB-eleID_loose-trigger-noPF-Et_25","", "", mcLabel_vec, "Energy corrections F: E_{SC}/(E_{rawSC}+E_{ES}) ", "", false, true); 
//   c->SaveAs(outputPath+"/energyCorrections_EB.eps");
//   delete c;

//   c = PlotDataMCs(data, MakeChainVector(signalA,signalB,signalC), "energySCEle/(rawEnergySCEle+esEnergySCEle)", "(100,0.99,1.15)", "EE-eleID_loose-trigger-noPF-Et_25","", "", mcLabel_vec, "Energy corrections F: E_{SC}/(E_{rawSC}+E_{ES}) ", "", false, true); 
