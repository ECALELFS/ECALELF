{
  ...
  TString constTermName="constTerm_absEta_1_1.4442-bad-Et_25-trigger-noPF-EB";
  //TString constTermName="constTerm_absEta_0_0.8-gold-Et_25-trigger-noPF-EB";
  //TString constTermName="constTerm_absEta_0.8_1.4442-bad-Et_25-trigger-noPF-EB";
  //TString constTermName="constTerm_absEta_0.8_1.4442-gold-Et_25-trigger-noPF-EB";
  ...
  TH2F *hprof = prof2d(tree,  TString(constTermName).ReplaceAll("-","_"), TString(alphaName).ReplaceAll("-","_"), "nll", 
		       "(241,-0.00025,0.24025,60,0.00025,0.03025)", true,true);
  hprof->Draw("colz");
