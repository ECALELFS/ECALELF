...
eleNewEnergiesProducer = cms.EDProducer('EleNewEnergiesProducer',
                                        ...
                                        regrEleJoshV6_SemiParam7TeVtrainFile = cms.string('src/Calibration/EleNewEnergiesProducer/data/regweights_v6_7TeV_forest_ele.root'),
                                        regrPhoJoshV6_SemiParam7TeVtrainFile = cms.string('src/Calibration/EleNewEnergiesProducer/data/regweights_v6_7TeV_forest_ph.root'),
                                        regrEleJoshV7_SemiParam7TeVtrainFile = cms.string('src/Calibration/EleNewEnergiesProducer/data/regweights_v7_7TeV_forest_ele.root'),
                                        regrPhoJoshV7_SemiParam7TeVtrainFile = cms.string('src/Calibration/EleNewEnergiesProducer/data/regweights_v7_7TeV_forest_ph.root'),
                                        regrEleJoshV8_SemiParam7TeVtrainFile = cms.string('src/Calibration/EleNewEnergiesProducer/data/regweights_v8_7TeV_forest_ele.root'),
                                        regrPhoJoshV8_SemiParam7TeVtrainFile = cms.string('src/Calibration/EleNewEnergiesProducer/data/regweights_v8_7TeV_forest_ph.root'),
